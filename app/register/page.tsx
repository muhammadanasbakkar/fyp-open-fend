              ...
              <div className="mt-4 border-t border-slate-100 pt-4 space-y-3">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-[34px] flex h-9 w-9 items-center justify-center rounded-md text-slate-500 hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#4b7eff]/30"
                  >
                    {showPw ? (
                      // Eye-off icon
