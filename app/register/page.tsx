    ...
    <div className="min-h-[calc(100dvh-64px)] bg-gradient-to-br from-slate-50 via-blue-50/30 to-white">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-4 pb-16 pt-10 sm:px-6 lg:flex-row lg:items-center">
        ...
        <div className="w-full lg:w-[55%]">
            ...
            >
              ...
              <div className="mt-4 border-t border-slate-100 pt-4 space-y-3">
                ...
                <div>
                  ...
                  {/* Relative wrapper is scoped to the input + button only so
                      the eye icon centers against the input, not the label. */}
                  <div className="relative">
                    <Input
                      type={showPw ? "text" : "password"}
                      placeholder="Create a strong password"
                    ...
                    <button
                      ...
                      className="absolute inset-y-0 right-1 my-auto flex h-9 w-9 items-center justify-center rounded-md text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#4b7eff]/30"
                    >
                      {showPw ? (
                        // Eye-off icon
          ...
          <p className="mt-6 text-center text-sm text-[#4b7eff]">
            Staff member?{" "}
            <Link
              href="/register/staff"
