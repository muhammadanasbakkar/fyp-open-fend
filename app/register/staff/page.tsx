...
//   // per-hospital fee inputs (keyed by hospitalId)
...
//   // --- Load hospitals on mount (public or protected depending on your backend) ---
//   useEffect(() => {
//     if (!therapist) return; // only needed for therapist role
//     (async () => {
//       try {
//         setHospErr("");
//         setHospLoading(true);
...
//   // Keep primaryHospital consistent (must be one of selected)
//   useEffect(() => {
...
//         // Primary hospital rule: if any selected, must choose one as primary
...
//                 value={form.cnic}
//                 onChange={(e) =>
//                   setForm((f: any) => ({ ...f, cnic: e.target.value }))
//                 }
//                 required
//               />
//             </div>
...
//                                 {/* Primary radio (only meaningful if selected) */}
